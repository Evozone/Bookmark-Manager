...
import { modalVisibilityAction, updateBookmarkInfoAction } from '../../../actions';
...
const IndividualBookmark = ({ websiteName, websiteURL, id }) => {
    ...
    const toggleModalVisibility = () => {
      dispatch(modalVisibilityAction(!modalVisibility, "updateBookmark", websiteName, websiteURL));
    }
    ...
    return (
        <Item className="item" id={id}>
            <ItemContent className="item-content">
                <CustomEditIcon updateBookmark={idForUpdateBookmark} dataId={id} />
